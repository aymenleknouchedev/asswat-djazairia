    ...
    <div class="web">
        ...
        <div class="container">
            ...
            <style>
                ...
                .custom-videos-feature .custom-image-wrapper {
                    position: relative;
                    width: 100%;
                    height: 100%;
                }

                .custom-videos-feature img {
                    width: 100%;
                    height: 100%;
                    object-fit: cover;
                    display: block;
                ...
                .custom-videos-feature .custom-corner-icon {
                    position: absolute;
                    bottom: 15px;
                    left: 20px;
                    width: 45px;
                ...
                .custom-videos-feature .custom-content {
                    margin-top: 20px;
                    display: flex;
                ...
                .custom-videos-feature .custom-content h3 {
                    margin: 0;
                    color: #999;
                    font-size: 12px;
                ...
                .custom-videos-feature .custom-content h2 {
                    margin: 10px 0 10px;
                    font-size: 24px;
                    line-height: 1.3;
                ...
                .custom-videos-feature .custom-content p {
                    margin: 0;
                    font-size: 17px;
                    line-height: 1.6;
                    color: #555;
                ...
                .custom-videos-feature .custom-content h2:hover {
                ...
                <div class="custom-videos-feature">
                    <a href="{{ route('news.show', $featured->shortlink) }}">
                        <div class="custom-image-wrapper">
                            <img loading="lazy" decoding="async" src="{{ $featured->media()->wherePivot('type', 'main')->first()->path }}"
            ...
            <div class="videos-section-wrapper">
                <div>
                    <div class="videos-section-grid" id="videos-container">
        ...
        <div class="mobile-flow">
            <div class="mobile-container" style="margin-top: 68px;">
                <div class="mobile-simple-list" dir="rtl">
                    <h2 class="mobile-simple-header">فيديو</h2>
                    <div style="padding: 0px 16px">
                        @include('user.components.ligne')
                    </div>
                    <ul class="mobile-simple-ul" role="list" id="mobile-videos-container">
                        @forelse ($otherVideos as $item)
                            @include('user.mobile.item')
                        @empty
                            <li style="padding: 12px 0; text-align: center; color: #999;">لا توجد فيديوهات حالياً.</li>
                        @endforelse
                    </ul>
                </div>
            </div>
        ...
        if (e.target.classList.contains("videos-load-more-btn")) {
            ...
            try {
                ...
                if (data.trim().length === 0) {
                    ...
                    document.querySelector("#videos-container").insertAdjacentHTML("beforeend", data);
